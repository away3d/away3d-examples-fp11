...
public class ShallowFluid
{
    ...
    [Embed("/pb/WaveDisplacement.pbj", mimeType="application/octet-stream")]
    private var DisplacementShaderClass:Class;
    private var _displacementShader:Shader;

    [Embed("/pb/WaveNormals.pbj", mimeType="application/octet-stream")]
    private var NormalsShaderClass:Class;
    private var _normalsShader:Shader;

    [Embed("/pb/WaveTangents.pbj", mimeType="application/octet-stream")]
