package away3d.primitives
{
	...
	public class RegularPolygonExample extends Sprite
	{
		...
		public function RegularPolygonExample()
		{
			super();
			...
			const light:LightBase = createLight();
		...
		{
			const geometry:RegularPolygonGeometry = new RegularPolygonGeometry(50);
		...
		{
			const light:DirectionalLight = new DirectionalLight(0, -1, 1);
